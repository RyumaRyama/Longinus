...
ActiveRecord::Schema.define(version: 2018_11_08_132016) do
  ...
  create_table "elements_users", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
